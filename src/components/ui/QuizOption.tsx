  ...
  return (
    <button
      ...
      className={cn(
        ...
        // Previne hover sticky no mobile
        'touch-manipulation',
        className
      )}
    >
      {/* Indicador visual de hover */}
      <div className="absolute left-0 top-0 bottom-0 w-1 bg-primary opacity-0 md:group-hover:opacity-100 transition-opacity" />
      
      <div className="flex items-center gap-3">
        {/* Círculo indicador */}
        <div className="w-5 h-5 rounded-full border-2 border-primary/30 md:group-hover:border-primary md:group-hover:bg-primary/20 transition-all flex-shrink-0" />

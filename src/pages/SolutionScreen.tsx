        ...
        <div className="flex-1 flex flex-col justify-between space-y-8 max-w-xl mx-auto w-full">
          ...
          <div className="text-center">
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 border-2 border-primary/30 text-primary rounded-lg font-medium hover:bg-primary/10 hover:border-primary/50 transition-all"
            >
              <span>Ver exatamente como funciona</span>
            </button>
          </div>

          {/* Lista do que recebe */}
          <div className="space-y-4" data-section="what-you-get">
